...
nwdApp.controller("notificationController", [
  ...
  function (
    ...
    $scope.getAvailableProviders = function () {
      ...
      $rootScope.loading = true;
      // get all providers
      $scope.template.frontDeskReq = false;
      $scope.template.isRegistered = true;
      $scope.template.requestingUser = $rootScope.user;
      $scope.template.count = "5";
      $scope.template.page = "1";
      console.log("\n $rootScope.user", $rootScope.user);
      doctorService.getDoctorsList().save($scope.template, function (response) {
